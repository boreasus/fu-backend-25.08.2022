...
router.get(("/api/fu_mobile/Insert_LawyerAppointment/:paramReferenceNo/:paramTime/:paramYear/:paramMonth/:paramDay/:category"), (req, res) => {
    ...
    insertLawyerAppointment(paramReferenceNo, paramTime, paramYear, paramMonth, paramDay, (data) =>  {
        parseString(data, (err, response) => {
            ...
            if(data['Insert_LawyerAppointmentResult'] == "OK"){
                ...
                var sql2 = `SELECT * FROM islemler WHERE islem_id="${paramReferenceNo.toUpperCase()}"`;
