...
router.get(("/api/fu_mobile/Insert_Attachment_With_Reference_Number_PDF_Images/:paramReferenceNumber/:paramAttachmentName/:imageData/:IpotekBelgesiYuklenmeTarihi/:islemTuru"), (req, res) => {
...
router.post(("/api/fu_mobile/Insert_Attachment_With_Reference_Number_PDF_Images"), (req, res) => {
    const paramReferenceNumber = req.params.paramReferenceNumber;
    const paramAttachmentName = req.params.paramAttachmentName;
    const imageData = req.params.imageData;
    const IpotekBelgesiYuklenmeTarihi = req.params.IpotekBelgesiYuklenmeTarihi;
