...
app.get(("/api/fu_mobile/UpdateVersiyonBilgisi/:pStrImeiNo/:pStrCihazBilgisi/:pStrVersiyonBilgisi/:pStrUygulamaVersiyonu"), (req, res) => {
    xmldata = XmlData;
    res.send(xmldata);
})
let data = {
...
app.post(("/api/fu_mobile/UpdateVersiyonBilgisi"), (req, res) => {
    let body = req.body;
    let query = req.query;
